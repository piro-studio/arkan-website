              ...
              <form ref={formRef} onSubmit={handleSubmit} noValidate>
                ...
                <div className="mt-5">
                  <label htmlFor="challenge" className={labelCls}>
                    بزرگ‌ترین چالش فعلی شما چیست؟<RequiredMark />
                  </label>
                  <select
                    id="challenge"
                    name="challenge"
                    ...
                    className={`${fieldBase} cursor-pointer appearance-none bg-[length:1rem] bg-[left_0.75rem_center] bg-no-repeat ${borderClasses(!!errors.challenge)} ${values.challenge ? "text-ink" : "text-slate/60"}`}
                    style={{
                      backgroundImage:
                  ...
                  >
                    ...
                    <option value="فروش متوقف شده یا کاهش یافته">فروش متوقف شده یا کاهش یافته</option>
                    <option value="نمی‌دانم چرا رشد نمی‌کنم">نمی‌دانم چرا رشد نمی‌کنم</option>
                    <option value="می‌خواهم وارد بازار جدیدی بشوم">می‌خواهم وارد بازار جدیدی بشوم</option>
                    <option value="ساختار سازمانی درست نیست">ساختار سازمانی درست نیست</option>
                    <option value="برند و بازاریابی ضعیف دارم">برند و بازاریابی ضعیف دارم</option>
                    <option value="چالش دیگری دارم">چالش دیگری دارم</option>
                  </select>
                  {errors.challenge && (
                    <p className={errorCls} aria-live="polite">{errors.challenge}</p>
                  )}
                </div>
                ...
                <p className="mt-4 text-center text-caption text-slate/60">
                  پاسخ ظرف ۲۴ ساعت کاری — بدون تعهد — کاملاً رایگان
                </p>
              </form>
            )}
          </div>
  ...
  return (
    <div>
      ...
      <textarea
        ...
        placeholder="مثلاً: فروشمان دو سال است متوقف شده و نمی‌دانیم مشکل از مدل کسب‌وکار است یا اجرا..."
      />
      {error && (
        <p id={errId} className={errorCls} aria-live="polite">
          {error}
